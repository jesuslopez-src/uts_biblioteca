...
class RegistroEstudianteWindow(Tk):
    ...
    def create_widgets(self):
        ...
        image_image_5_width= int(background_image.width()*4/self.num_columnas)
        ...
        canvas.create_image(background_image.width()*25/self.num_columnas, background_image.height()*11/self.num_filas, image=image_image_5,anchor=constants.NW)
        ...
        entry_3_x = background_image.width()*30/self.num_columnas
        ...
        button_2.place(anchor="center",x=background_image.width()*30/self.num_columnas, y=background_image.height()*16/self.num_filas, width=button_image_2.width(), height=button_image_2.height())
        ...
        canvas.create_image(background_image.width()*25/self.num_columnas, background_image.height()*9/self.num_filas, image=image_image_2,anchor=constants.NW)
        ...
        canvas.create_image(background_image.width()*25/self.num_columnas, background_image.height()*13/self.num_filas, image=image_image_3,anchor=constants.NW)
        ...
        image_image_4_width= int(background_image.width()*25/self.num_columnas)
        ...
        canvas.create_image(background_image.width()*30/self.num_columnas, background_image.height()*6/self.num_filas, image=image_image_4)
